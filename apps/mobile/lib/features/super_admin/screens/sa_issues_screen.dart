...
class SaIssuesScreen extends ConsumerStatefulWidget {
  const SaIssuesScreen({super.key});

  @override
  ConsumerState<SaIssuesScreen> createState() => _SaIssuesScreenState();
}

class _SaIssuesScreenState extends ConsumerState<SaIssuesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Issues & Alerts'),
